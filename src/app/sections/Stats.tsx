    ...
    <section id="stats" className="section relative w-full overflow-hidden">
      <div className="relative w-full h-auto sm:h-[1250px] md:h-[1400px]">
        ...
        <div className="sm:hidden flex flex-col items-center gap-0 py-0 relative">
          ...
          <div className="w-full px-0 max-w-[1200px] -mt-75 transform -translate-x-32 ml-20 z-30">
            <Image
              src="/870+ no grain.webp"
              alt="870+ registrants"
              width={1200}
              height={800}
              className="w-full h-auto scale-65"
        ...
        <div className="hidden sm:block">
          {/* LEFT – 24 hours */}
          <div className="absolute left-[-6%] sm:left-[-18%] top-[2%] z-20">
            <Image
              src="/24 hours no grain.webp"
              alt="24 hours"
              width={2200}
          ...
          {/* LEFT – 870+ */}
          <div className="absolute left-[-6%] sm:left-[12%] top-[55%] z-20">
            <Image
              src="/870+ no grain.webp"
              alt="870+ registrants"
              width={2800}
              height={1200}
              className="h-auto w-[clamp(120px,40vw,800px)]"
            />
          </div>
